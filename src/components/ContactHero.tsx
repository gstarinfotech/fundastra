...
export default function ContactHero() {
  return (
    <section className="relative">
      <div className="relative min-h-[640px] overflow-hidden sm:min-h-[709px]">
        <Image
          src="/about.png"
        ...
        <motion.div
          className="relative z-10 max-w-[720px] px-4 pb-12 pt-36 sm:pb-20 sm:pt-55 lg:ml-[93px] lg:px-0"
        ...
        >
          ...
          <motion.div
            ...
            className="mb-5 inline-flex max-w-full flex-wrap items-center gap-2 rounded-[5px] bg-white/95 px-3 py-2 backdrop-blur sm:mb-6 sm:px-5"
          >
          ...
          <motion.p
            variants={textVariants}
            className="mt-5 max-w-[590px] font-sans text-[14px] font-[300] leading-[1.55] text-[#CAEADBE5] sm:mt-6 sm:text-[19px] sm:leading-[1.65]"
          >
          ...
          <motion.div
            variants={containerVariants}
            className="mt-7 grid grid-cols-2 gap-2 sm:mt-9 sm:grid-cols-4 sm:gap-4"
          >
            {STATS.map((stat) => (
              <motion.div
                key={stat.label}
